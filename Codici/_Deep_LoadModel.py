...
model = keras.models.load_model('/home/silvia/Documents/GitHub/primoprogetto/Codici/Tentativi/7/Tentativo_7.hdf5')
model.summary()
yp = model.predict(x)
print(y, len(y), "\n", yp, len(yp))
yp_ok = []
...
Dati.plotta(tracce_previsione_errata, 130, "figure_previsione_errata_15", "/home/silvia/Desktop/Pollino")
Dati.plotta(tracce_previsione_incerta, 130, "figure_previsione_incerta_15", "/home/silvia/Desktop/Pollino")  # TODO
dizio = {"traccia": Dati.metadata["trace_name"], "y_a_Mano": y, "y_predict": yp_ok, "delta": delta_y}
datapandas = pd.DataFrame.from_dict(dizio)
datapandas.to_csv('/home/silvia/Desktop/Predizioni_Pollino_semiampiezza_15.csv', index=False)                # TODO
