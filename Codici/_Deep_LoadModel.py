...
dizio_val = {"traccia": Dati_.metadata["trace_name"], "y_Mano": y_pol_true, "y_predict": y_predicted_ok,
             "delta": delta_y}
print(len(Dati_.metadata["trace_name"]), len(y_pol_true), len(y_predicted_ok), len(delta_y))
